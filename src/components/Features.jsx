...
import { details, features } from "../constanst/index.js";
                        ...
                        <div className="flex relative md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3"> 
                            {
                                features.map(({id , icon , title , text , button , caption}) => (
                                    <div key={id} className="relative z-2 md:px-10 px-5 md:pb-10 pb-5 flex-50 max-md:g7 max-md:boeder-2 max-md:boeder-s3 max-md:rounded-3xl max-md:flex-320" >
                                        ...
                                        <p className="caption max-md:mb-5 mb-5">{caption}</p>
                            ...
                            <ul className="flex relative justify-around items-center flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden ">
